...
\renewcommand*{\makecvtitle}{%
  \setlength{\makeheaddetailswidth}{\textwidth}\hfil\parbox{\makeheaddetailswidth}{\centering%
    ...
    {}%
    {{\centering{\raisebox{-26mm}[0pt][0pt]{\begin{minipage}{1.2\quotewidth}\centering\quotestyle{\@quote}\end{minipage}}}\\[8.2em]}}%
  \par\makecvfoot}%
\makeatother
...
\section{Education}
\cventry{2011--2013}{M.S. in Computer Science}{Rowan University}{Glassboro, NJ}{\textit{3.9}}{Alpha Epsilon Lambda Honor Society}  % arguments 3 to 6 can be left empty
...
\cventry{2019--2021}{Software Developer}{Edmunds GovTech}{Northfield, NJ}{}{MCSJ/Sabre - Financial ERP Solutions for Local Government.
  \begin{itemize}
    \item Helped kick-off the re-engineering of legacy software including backend and frontend components, as well as a new test framework.
          \begin{itemize}
    ...
    \item Introduced a framework for testing legacy product code.
          ...
          \end{itemize}
    \item Working with our Concept team, worked on the implementation and launch of new, client-focused features.
          \begin{itemize}
            \item Integration of SalesForce (Java, SalesForce Lightning REST API)
...
\cventry{2015--2019}{Lead Java Software Developer}{Computer Service \& Support}{Linwood, NJ}{}{Avalon Laboratory Information System for clinical and toxicology labs.
  \begin{itemize}
    \item Started during the intial stages of a relaunch of our LIS software.
...
\cvskillentry{}{2}{Angular}{1}{Used in re-engineering a Swing/JavaFX frontend}
\cvskillentry{}{2}{JavaScript}{1}{AWS Lambda as well as frontend work experience}
...
\cvskillhead[-0.2em]%
\cvskillentry*{DevOps:}{4}{AWS CloudFormation}{3}{AWS training. Infrastructure as code}
\cvskillentry{}{4}{AWS CloudWatch}{3}{Monitoring applications and infrastructure}
...
\section{Interests}
\cvitem{Linux}{\emph{I've had fun tinkering with Linux since first installing Slackware back in high school}}
\cvitem{Guitar}{\emph{Just starting to learn! It has been a great distraction from things during Covid}}
\cvitem{Biking}{\emph{Outdoors, great exercise. Excited for the warmer weather!}}
